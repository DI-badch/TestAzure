...
from typing import Any, AnyStr, AsyncIterable, Dict, IO, Iterable, List, Optional, overload, Tuple, Union, TYPE_CHECKING
...
from ._upload_helpers import upload_block_blob, upload_append_blob, upload_page_blob, _any_conditions
...
class BlobClient(StorageAccountHostsMixin, StorageEncryptionMixin):  # pylint: disable=too-many-public-methods
    ...
    def upload_blob_from_url(self, source_url, **kwargs):
        ...
        :rtype: Dict[str, Any]
        """
        options = self._upload_blob_from_url_options(source_url=self._encode_source_url(source_url), **kwargs)
        try:
    ...
    def upload_blob(
        ...
        **kwargs,
        ...
        """
        options = self._upload_blob_options(data, blob_type=blob_type, length=length, metadata=metadata, **kwargs)
        if blob_type == BlobType.BlockBlob:
    ...
    @overload
    def download_blob(
        self, offset: int = None, length: int = None, *, encoding: str, **kwargs
    ) -> StorageStreamDownloader[str]: ...

    @overload
    def download_blob(
        self, offset: int = None, length: int = None, *, encoding: None = None, **kwargs
    ) -> StorageStreamDownloader[bytes]: ...

    @distributed_trace
    def download_blob(
        self, offset: int = None, length: int = None, *, encoding: Optional[str] = None, **kwargs
        ...
        """
        options = self._download_blob_options(offset=offset, length=length, encoding=encoding, **kwargs)
        return StorageStreamDownloader(**options)

    def _quick_query_options(self, query_expression, **kwargs):
        # type: (str, **Any) -> Dict[str, Any]
        delimiter = "\n"
    ...
    def create_append_blob(self, content_settings=None, metadata=None, **kwargs):
        ...
        :rtype: dict[str, Any]
        """
        options = self._create_append_blob_options(content_settings=content_settings, metadata=metadata, **kwargs)
        try:
    ...
    def stage_block(
        ...
        **kwargs,
        ...
        :rtype: dict[str, Any]
        """
        options = self._stage_block_options(block_id, data, length=length, **kwargs)
        try:
    ...
    def commit_block_list(  # type: ignore
        ...
        **kwargs,
        ...
        options = self._commit_block_list_options(
            block_list, content_settings=content_settings, metadata=metadata, **kwargs
        )
        try:
    ...
    def get_page_ranges(  # type: ignore
        ...
        **kwargs,
        ...
        options = self._get_page_ranges_options(
            offset=offset, length=length, previous_snapshot_diff=previous_snapshot_diff, **kwargs
        )
        try:
            if previous_snapshot_diff:
    ...
    def get_page_range_diff_for_managed_disk(
        self,
        previous_snapshot_url,  # type: str
        offset=None,  # type: Optional[int]
        length=None,  # type: Optional[int]
        **kwargs,
    ):
    ...
    def set_sequence_number(self, sequence_number_action, sequence_number=None, **kwargs):
        ...
        :rtype: dict(str, Any)
        """
        options = self._set_sequence_number_options(sequence_number_action, sequence_number=sequence_number, **kwargs)
        try:
    ...
    def upload_page(  # type: ignore
        ...
        **kwargs,
        ...
        :rtype: dict(str, Any)
        """
        options = self._upload_page_options(page=page, offset=offset, length=length, **kwargs)
        try:
    ...
    def append_block(  # type: ignore
        ...
        **kwargs,
        ...
        :rtype: dict(str, Any)
        """
        options = self._append_block_options(data, length=length, **kwargs)
        try:
