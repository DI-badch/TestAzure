...
import functools
import warnings
from typing import Any, AnyStr, Dict, List, IO, Iterable, Iterator, Optional, overload, Union, TYPE_CHECKING
...
from ._shared.response_handlers import process_storage_error, return_response_headers, return_headers_and_deserialized
...
from ._models import ContainerProperties, BlobProperties, BlobType, FilteredBlob
...
class ContainerClient(StorageAccountHostsMixin, StorageEncryptionMixin):  # pylint: disable=too-many-public-methods
    ...
    def list_blobs(
        ...
        return ItemPaged(
            command, prefix=name_starts_with, results_per_page=results_per_page, page_iterator_class=BlobPropertiesPaged
        )
    ...
    def list_blob_names(self, **kwargs: Any) -> ItemPaged[str]:
        ...
        return ItemPaged(
            command, prefix=name_starts_with, results_per_page=results_per_page, page_iterator_class=BlobNamesPaged
        )
    ...
    def walk_blobs(
        ...
        **kwargs: Any,
        ...
        return BlobPrefix(command, prefix=name_starts_with, results_per_page=results_per_page, delimiter=delimiter)

    @distributed_trace
    def find_blobs_by_tags(
        self,
        filter_expression,  # type: str
    ...
    @distributed_trace
    def delete_blob(self, blob: str, delete_snapshots: Optional[str] = None, **kwargs: Any):
        # type: (...) -> None
    ...
    @overload
    def download_blob(
        self, blob: str, offset: int = None, length: int = None, *, encoding: str, **kwargs: Any
    ) -> StorageStreamDownloader[str]: ...

    @overload
    def download_blob(
        self, blob: str, offset: int = None, length: int = None, *, encoding: None = None, **kwargs: Any
    ) -> StorageStreamDownloader[bytes]: ...

    @distributed_trace
    def download_blob(
        self, blob: str, offset: int = None, length: int = None, *, encoding: Optional[str] = None, **kwargs: Any
    ...
    def _generate_delete_blobs_subrequest_options(
        ...
        **kwargs,
        ...
        if snapshot is not None:
            query_parameters["snapshot"] = self._client._serialize.query(
                "snapshot", snapshot, "str"
            )  # pylint: disable=protected-access
        if version_id is not None:
            query_parameters["versionid"] = self._client._serialize.query(
                "version_id", version_id, "str"
            )  # pylint: disable=protected-access
        if timeout is not None:
            query_parameters["timeout"] = self._client._serialize.query(
        ...
        if if_tags is not None:
            header_parameters["x-ms-if-tags"] = self._client._serialize.header(
                "if_tags", if_tags, "str"
            )  # pylint: disable=protected-access

        return query_parameters, header_parameters

    def _generate_delete_blobs_options(self, *blobs: Union[str, Dict[str, Any], BlobProperties], **kwargs: Any):
        timeout = kwargs.pop("timeout", None)
    ...
    def _generate_set_tiers_subrequest_options(
        ...
        query_parameters["comp"] = self._client._serialize.query(
            "comp", comp, "str"
        )  # pylint: disable=protected-access, specify-parameter-names-in-call

        # Construct headers
        header_parameters = {}
        header_parameters["x-ms-access-tier"] = self._client._serialize.header(
            "tier", tier, "str"
        )  # pylint: disable=protected-access, specify-parameter-names-in-call
        ...
        if lease_id is not None:
            header_parameters["x-ms-lease-id"] = self._client._serialize.header(
                "lease_id", lease_id, "str"
            )  # pylint: disable=protected-access
        if if_tags is not None:
            header_parameters["x-ms-if-tags"] = self._client._serialize.header(
