...
class BlobNamesPaged(PageIterator):
    ...
    def __init__(
        self, command, container=None, prefix=None, results_per_page=None, continuation_token=None, location_mode=None
    ):
...
class FilteredBlobPaged(PageIterator):
    ...
    def __init__(self, command, container=None, results_per_page=None, continuation_token=None, location_mode=None):
