...
from typing import Union, Optional, Any, TYPE_CHECKING  # pylint: disable=unused-import
...
if TYPE_CHECKING:
    ...
    from ..blob import ResourceTypes, AccountSasPermissions, ContainerSasPermissions, BlobSasPermissions
...
def generate_container_sas(
    ...
    **kwargs,  # type: Any
    ...
    return sas.generate_container(
        container_name, permission=permission, expiry=expiry, start=start, policy_id=policy_id, ip=ip, **kwargs
    )
