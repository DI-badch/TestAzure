...
from ._upload_helpers import upload_block_blob, upload_append_blob, upload_page_blob
...
class BlobClient(
    AsyncStorageAccountHostsMixin, BlobClientBase, StorageEncryptionMixin
    ...
    async def set_sequence_number(  # type: ignore
        self,
        sequence_number_action,  # type: Union[str, SequenceNumberAction]
