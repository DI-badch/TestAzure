...
class BlobServiceClient(AsyncStorageAccountHostsMixin, BlobServiceClientBase, StorageEncryptionMixin):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(BlobServiceClient, self).__init__(account_url, credential=credential, **kwargs)
    ...
    async def set_service_properties(
        self,
        analytics_logging=None,  # type: Optional[BlobAnalyticsLogging]
    ...
    async def delete_container(
        ...
        **kwargs: Any
        ...
        kwargs.setdefault("merge_span", True)
        timeout = kwargs.pop("timeout", None)
        await container.delete_container(lease=lease, timeout=timeout, **kwargs)  # type: ignore
